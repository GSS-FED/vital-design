...
import { CloudSidebar } from '@/blocks/sidebar-cloud-06/components/app-sidebar';
import {
  SidebarInset,
  SidebarProvider,
  SidebarTrigger,
...
export function SidebarCloud06Preview() {
  return (
    <ComponentPreview name="SidebarCloud06Preview">
