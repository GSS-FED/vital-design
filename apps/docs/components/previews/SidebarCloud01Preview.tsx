...
import { CloudSidebar } from '@/blocks/sidebar-cloud-01/components/app-sidebar';
import {
  SidebarInset,
  SidebarProvider,
  SidebarTrigger,
...
export function SidebarCloud01Preview() {
  return (
    <ComponentPreview name="SidebarCloud01Preview">
