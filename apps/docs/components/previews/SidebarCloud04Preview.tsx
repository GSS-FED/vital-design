...
import { CloudSidebar } from '@/blocks/sidebar-cloud-04/components/app-sidebar';
import {
  SidebarInset,
  SidebarProvider,
  SidebarTrigger,
...
export function SidebarCloud04Preview() {
  return (
    <ComponentPreview name="SidebarCloud04Preview">
