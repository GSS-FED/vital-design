...
import { CloudSidebar } from '@/blocks/sidebar-cloud-03/components/app-sidebar';
import {
  SidebarInset,
  SidebarProvider,
  SidebarTrigger,
...
export function SidebarCloud03Preview() {
  return (
    <ComponentPreview name="SidebarCloud03Preview">
