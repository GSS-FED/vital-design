...
import { CloudSidebar } from '@/blocks/sidebar-cloud-02/components/app-sidebar';
import {
  SidebarInset,
  SidebarProvider,
  SidebarTrigger,
...
export function SidebarCloud02Preview() {
  return (
    <ComponentPreview name="SidebarCloud02Preview">
