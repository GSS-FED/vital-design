...
6. **文件一致性檢查**
   ...
   - `CLAUDE.md` Commands 是否列出所有 root `package.json` 中的主要 scripts（含 `docs:*`、`registry:*`、`tokens:*`）
   ...
   - `CLAUDE.md` Project Structure 是否反映 monorepo 結構（含 `apps/docs/`）
   - `CLAUDE.md` Tech Stack 是否包含文件站的 Fumadocs / Next.js / rehype-pretty-code
   - `CLAUDE.md` AI Commands / AI Skills 是否與 `.claude/commands/`、`.claude/skills/` 一致
