...
function ResizableHandle({
  ...
  return (
    <ResizablePrimitive.Separator
      ...
      className={cn(
        'relative flex w-px shrink-0 items-center justify-center bg-grayscale-opacity-300 outline-none transition-colors duration-100',
      ...
      {children ??
        (withHandle ? (
          <span
            ...
            className="z-10 flex h-4 w-3 items-center justify-center gap-px rounded-xs border border-grayscale-opacity-300 bg-white text-grayscale-opacity-500 shadow-base"
          >
