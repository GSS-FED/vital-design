...
>(function Input(props, ref) {
  ...
  return (
    <InputPrimitive
      ...
      disabled={disabled}
      className={cn(
        'box-border flex h-8 w-full min-w-0 rounded border border-grayscale-opacity-300 bg-white px-2 py-1.5 font-sans text-sm leading-5 font-normal text-grayscale-opacity-800 transition-colors duration-200 outline-none',
