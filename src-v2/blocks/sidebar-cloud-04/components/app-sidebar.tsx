...
const data = {
  ...
  navSecondary: [
    { title: 'Support', icon: <InfoIcon /> },
    { title: 'Privacy Policy', icon: <ShieldCheckIcon /> },
  ] as { title: string; icon: ReactNode }[],
};
...
function NavSecondary() {
  return (
    <SidebarGroup className="mt-auto px-3 py-2 pb-8 group-data-[collapsible=icon]:p-3! group-data-[collapsible=icon]:pb-8!">
      <SidebarGroupContent>
        <SidebarMenu>
