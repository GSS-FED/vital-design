  ...
  return (
    <div className="flex size-8 shrink-0 items-center justify-center">
      <img
        src={data.logos.mark}
        alt="Brand"
        className="size-8 shrink-0 object-contain object-left"
      />
    </div>
  );
}
...
const headerActionButtonClass =
  'size-8 overflow-visible rounded-md p-0! [&_[data-icon]]:m-0 [&_[data-icon]]:size-4!';
...
function HeaderActions() {
  return (
    <div
      ...
      className="ml-auto flex items-center gap-1 group-data-[collapsible=icon]:hidden"
    >
      <Button
        variant="ghost"
        size="icon-md"
      ...
      <Button
        ...
        className={headerActionButtonClass}
      >
        <BellIcon data-icon className="relative" />
        <Badge
          size="md"
          type="number"
          variant="primary"
          className="pointer-events-none absolute top-0 right-0 translate-x-1/2 -translate-y-1/2 z-2"
        >
          3
        </Badge>
      </Button>
...
function Header({
  ...
  return (
    <SidebarHeader
      className={cn(
        'flex-row items-center gap-2 p-4 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:p-3!',
        className,
      )}
      {...props}
    >
