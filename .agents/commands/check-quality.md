...
6. **文件一致性檢查**
   ...
   重點確認項目：
   - `AGENTS.md` 的 commands 區塊是否覆蓋 root `package.json` 中的主要 scripts（含 `docs:*`、`registry:*`、`tokens:*`）
   ...
   - `AGENTS.md` 的 AI Commands / AI Skills 是否與 `.agents/commands/`、`.agents/skills/` 一致
